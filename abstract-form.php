<form action="<?php if (ABSTRACT_OPEN == true) {
    echo $_SERVER['PHP_SELF'];
} ?>" role="form" class="form-horizontal" id="igm-abstract" method="post" name="" >
...
<div class="row">
    ...
    echo 'disabled="true"';
					...
					<option <?php if (ABSTRACT_OPEN != true) {
    echo 'disabled="true"';
    ...
    echo 'disabled="true"';
		...
		<div class="form-group ">
			...
			<div class="">
				<input <?php if (ABSTRACT_OPEN != true) {
    echo 'disabled="true"';
} ?> class="form-control" id="addressLine1" maxlength="255" name="addressLine1" placeholder="Address..." type="text" value="<?php echo htmlspecialchars(@$fields['addressLine1']); ?>" required>
			</div>
		</div>
...
<textarea <?php if (ABSTRACT_OPEN != true) {
    echo 'disabled="true"';
} ?> class="form-control" id="coauthors" name="coauthors" rows="5">
...
<textarea <?php if (ABSTRACT_OPEN != true) {
    echo 'disabled="true"';
} ?> class="form-control" id="abstract-title" name="abstract_title" rows="1" required>
...
<textarea <?php if (ABSTRACT_OPEN != true) {
    echo 'disabled="true"';
} ?> class="form-control" id="keywords" name="keywords" rows="2" required>
...
<legend class="description" for="area[]">Scientific area(s) </legend>
  <div id="roles-div" class="form-group col-md-12 form-el-inline">
	<label class="checkbox-inline">
	  <input <?php if (ABSTRACT_OPEN != true) {
    echo 'disabled="true"';
} ?> type="checkbox" id="area1" name="area[]" value="CCCV" <?php apn_check_fields('area', 'CCCV'); ?>>
	...
	<label class="checkbox-inline">
	  <input <?php if (ABSTRACT_OPEN != true) {
    echo 'disabled="true"';
} ?> type="checkbox" id="area2" name="area[]" value="EBLU" <?php apn_check_fields('area', 'EBLU'); ?> > 
	...
	<label class="checkbox-inline">
	  <input <?php if (ABSTRACT_OPEN != true) {
    echo 'disabled="true"';
} ?> type="checkbox" id="area3" name="area[]" value="CATMD" <?php apn_check_fields('area', 'CATMD'); ?> > 
	...
	<label class="checkbox-inline">
	  <input <?php if (ABSTRACT_OPEN != true) {
    echo 'disabled="true"';
} ?> type="checkbox" id="area4" name="area[]" value="RUSD" <?php apn_check_fields('area', 'RUSD'); ?>> 
...
<textarea <?php if (ABSTRACT_OPEN != true) {
    echo 'disabled="true"';
} ?> class="form-control" id="abstract" name="abstract" rows="15" required>
...
<input <?php if (ABSTRACT_OPEN != true) {
    echo 'disabled="true"';
} ?> class="btn btn-lg btn-success" id="submit" name="submit" type="submit" value="Submit">
