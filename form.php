    ...
    echo 'disabled="true"';
		...
		<div class="form-group col-md-2 form-el-inline">
			...
			<div class="">
				<input <?php if (REGISTRATION_OPEN != true) {
    echo 'disabled="true"';
} ?>   class="form-control" id="suffix" name="suffix" size="3" placeholder="Suffix..."  type="text" value="<?php echo htmlspecialchars(@$fields['suffix']); ?>">
			</div>
		</div>
</div> <!--row -->	
...
<label for="role[]" class="control-label required">I'm participating as: </label>
  <div id="roles-div" class="form-group col-md-12 form-el-inline">
	<label class="checkbox-inline">
	  <input <?php if (REGISTRATION_OPEN != true) {
    echo 'disabled="true"';
} ?>   type="checkbox" id="role1" name="role[]" value="nFP" <?php apn_check_fields('role', 'nFP'); ?> >
	...
	<label class="checkbox-inline">
	  <input <?php if (REGISTRATION_OPEN != true) {
    echo 'disabled="true"';
} ?>   type="checkbox" id="role2" name="role[]" value="SC" <?php apn_check_fields('role', 'SC'); ?> > 
	...
	<label class="checkbox-inline">
	  <input <?php if (REGISTRATION_OPEN != true) {
    echo 'disabled="true"';
} ?>   type="checkbox" id="role3" name="role[]" value="SPG" <?php apn_check_fields('role', 'SPG'); ?> > 
	...
	<label class="checkbox-inline">
	  <input <?php if (REGISTRATION_OPEN != true) {
    echo 'disabled="true"';
} ?>   type="checkbox" id="role4" name="role[]" value="CDC" <?php apn_check_fields('role', 'CDC'); ?> > 
	...
	<label class="checkbox-inline">
	  <input <?php if (REGISTRATION_OPEN != true) {
    echo 'disabled="true"';
} ?>   type="checkbox" id="role5" name="role[]" value="Partner" <?php apn_check_fields('role', 'Partner'); ?> > <abbr title="Partner organisation representatives, invited speakers at interactive sessions, etc."> Partner / Invited Speaker / Observer </abbr>
	</label>

	<label class="checkbox-inline">
	  <input <?php if (REGISTRATION_OPEN != true) {
    echo 'disabled="true"';
} ?>   type="checkbox" id="role7" name="role[]" value="Secretariat" <?php apn_check_fields('role', 'Secretariat'); ?> > <abbr title="Secretariat and staff">APN Secretariat</abbr>
	</label>
	
	<!--label class="checkbox-inline">
	  <input <?php if (REGISTRATION_OPEN != true) {
    echo 'disabled="true"';
} ?> type="checkbox" id="role6" name="role[]" value="Young scientist" <?php apn_check_fields('role', 'Young scientist'); ?> > <abbr title="Young/early-career scientists participating in the poster session"> Young Scientist </abbr>
	</label-->
  </div>
</div>
...
<span class="help-block">This information will be used for official correspondence and will be included the participants list of the IGM Proceedings.</span>
		...
		<div class="form-group">
			...
			<div class="">
				<input <?php if (REGISTRATION_OPEN != true) {
    echo 'disabled="true"';
} ?>   class="form-control" id="jobTitle" maxlength="255" name="jobTitle" placeholder="Position/Job Title..."  type="text" value="<?php echo htmlspecialchars(@$fields['jobTitle']); ?>" required>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="">
				<input <?php if (REGISTRATION_OPEN != true) {
    echo 'disabled="true"';
} ?>   class="form-control" id="department" maxlength="255" name="department"  placeholder="Section/Department..."  type="text"  value="<?php echo htmlspecialchars(@$fields['department']); ?>" >
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="">
				<input <?php if (REGISTRATION_OPEN != true) {
    echo 'disabled="true"';
} ?>   class="form-control" id="organisation" maxlength="255" name="organisation" placeholder="Organisation..." type="text" value="<?php echo htmlspecialchars(@$fields['organisation']); ?>" required>
			</div>
		</div>
		...
		<div class="form-group ">
			...
			<div class="">
				<input <?php if (REGISTRATION_OPEN != true) {
    echo 'disabled="true"';
} ?>   class="form-control" id="addressLine1" maxlength="255" name="addressLine1" placeholder="Address line 1..." type="text" value="<?php echo htmlspecialchars(@$fields['addressLine1']); ?>" required>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="">
				<input <?php if (REGISTRATION_OPEN != true) {
    echo 'disabled="true"';
} ?>   class="form-control" id="addressLine2" maxlength="255" name="addressLine2" placeholder="Address line 2..." type="text" value="<?php echo htmlspecialchars(@$fields['addressLine2']); ?>">
			</div>
		</div>
...
<div class="row">
		...
		<div class="form-group col-md-3 form-el-inline">
			...
			<div class="">
				<input <?php if (REGISTRATION_OPEN != true) {
    echo 'disabled="true"';
} ?>   class="form-control" id="passportNo"  name="passportNo" type="text" placeholder="Passport number..." value="<?php echo htmlspecialchars(@$fields['passportNo']); ?>" required> 
			</div>
        </div>
...
<div class="row">
		<div class="form-group col-md-4 form-el-inline">
			...
			<div class="">
				<input <?php if (REGISTRATION_OPEN != true) {
    echo 'disabled="true"';
} ?>   class="form-control" id="issuingAuth"  name="issuingAuth" type="text" placeholder="Issuing authority..." value="<?php echo htmlspecialchars(@$fields['issuingAuth']); ?>" required>
			</div>
        </div>
		...
		<div class="form-group col-md-4 form-el-inline">
			...
			<div class="">
				<input <?php if (REGISTRATION_OPEN != true) {
    echo 'disabled="true"';
} ?>   class="form-control hasDatePicker" id="dateOfIssue"  name="dateOfIssue" type="text" placeholder="dd/mm/yyyy" value="<?php echo htmlspecialchars(@$fields['dateOfIssue']); ?>" required>
			</div>
        </div>
		...
		<div class="form-group col-md-4 form-el-inline">
			...
			<div class="">
				<input <?php if (REGISTRATION_OPEN != true) {
    echo 'disabled="true"';
} ?>   class="form-control hasDatePicker" id="dateOfExpiry"  name="dateOfExpiry" type="text" placeholder="dd/mm/yyyy"  value="<?php echo htmlspecialchars(@$fields['dateOfExpiry']); ?>" required>
			</div>
        </div>
</div>
...
<textarea <?php if (REGISTRATION_OPEN != true) {
    echo 'disabled="true"';
} ?>   class="form-control" id="requirements" name="requirements" rows="4">
